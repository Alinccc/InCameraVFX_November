...
Nipple.prototype.buildEl = function () {
    this.ui = {};
    ...
    let knobTitleWrapper = document.createElement('div');
    knobTitleWrapper.style.display = "flex";
    knobTitleWrapper.style.height = "100%";
    knobTitleWrapper.style.alignItems = "center";
    knobTitleWrapper.style.justifyContent = "center";

    let knobTitle = document.createElement('p');
    knobTitle.innerHTML = this.options.knobTitle;
    knobTitle.className = "knob-title";
    knobTitle.style.color = "#000000ff";
    knobTitleWrapper.appendChild(knobTitle);
    this.ui.front.appendChild(knobTitleWrapper);
...
Nipple.prototype.stylize = function () {
    ...
    styles.front = {
        ...
        background: this.options.color,
        'opacity': '1',
        'box-shadow': '0 0 5px 1px #000000b0'
    };
