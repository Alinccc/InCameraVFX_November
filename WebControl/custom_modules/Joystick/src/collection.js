...
Collection.prototype.triggerResize = function() {
  var self = this;
  self.manager.triggerResize();
}
...
Collection.prototype.prepareNipples = function () {
    ...
    nips.ids = self.ids;
    nips.id = self.id;
    nips.triggerResize = self.triggerResize.bind(self);
...
Collection.prototype.onstart = function (evt) {
    if (evt.target.nodeName === "I") {
      // Handle clicking an icon instead
      return;
    }
    var self = this;
    var opts = self.options;
